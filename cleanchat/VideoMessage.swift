...
class VideoMessage: JSQMediaItem {      // will create video class and return video item
    ...
    init(withFileURL: NSURL, maskOutgoing: Bool) {
        ...
        fileURL = withFileURL   // get video image view
        videoImageView = nil
    }
    ...
    override func mediaView() -> UIView! {
        if let st = status {
            ...
            if st == 2 && (self.videoImageView == nil) {        // create video message
                print("SUCCESS")
