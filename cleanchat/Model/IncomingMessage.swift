...
public class IncomingMessage {
    ...
    private func imageFromData(item: NSDictionary, result: (_ image: UIImage?) -> Void) {
    ...
    private func returnOutgoingStatusFromUser(senderId: String) -> Bool {        // check if media is incoming or outgoing
